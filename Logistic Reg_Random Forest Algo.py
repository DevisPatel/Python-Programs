...
print("\n \n Accuracy of RANDOM FOREST ALGORITHM    is       :          ",metrics.accuracy_score(prediction,test_y))
...
print("\n \n Accuracy of DECISION TREE ALGORITHM    is       :          ",metrics.accuracy_score(pred_y,test_y))
